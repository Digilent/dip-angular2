...
import { SimulatedAnalogLoggerService } from './instruments/simulated-analog-logger.service';
...
@Injectable()
export class SimulatedOpenScopeService {
    ...
    public logger: SimulatedAnalogLoggerService;
    ...
    constructor(enumeration) {
        ...
        this.logger = new SimulatedAnalogLoggerService(this.simDevService);
    }
